{
  ...
  rocq-elpi-version = "ba3cc750eda486c85d94e3eb35fb0eba77609338";
  in {
    "rocq-9.0" = {
      rocqPackages = { rocq-core.override.version = "9.0"; 
        rocq-elpi.override.version = rocq-elpi-version; # 3.4.0. is enough for trocq-std, trocq-hott needs https://github.com/LPCIC/coq-elpi/pull/1030
	};
      coqPackages = common-bundles // { 
        coq.override.version = "9.0"; 
        coq-elpi.override.version = rocq-elpi-version; # 3.4.0. is enough for trocq-std, trocq-hott needs https://github.com/LPCIC/coq-elpi/pull/1030
      };
    };
    "rocq-9.1" = {
