...
Proof.
  ...
  specialize (R_in_mapK idmap idmap).
  ...
  remember (R_in_map idmap idmap rf) as R_in_mapf eqn:R_in_mapf_eq.
  remember (R_in_map idmap idmap rt) as R_in_mapt eqn:R_in_mapt_eq.
...
Proof.
  rewrite -{3}(equiv_path_universe _ _ (equiv_inverse equiv_bool_aut_bool)).
